...
export const auxiliaryData_setMetadata = self => metadata => errorableToPurs(self.set_metadata.bind(self), metadata);
export const auxiliaryData_nativeScripts = self => () => self.native_scripts.bind(self)();
export const auxiliaryData_setNativeScripts = self => native_scripts => errorableToPurs(self.set_native_scripts.bind(self), native_scripts);
export const auxiliaryData_plutusScripts = self => () => self.plutus_scripts.bind(self)();
export const auxiliaryData_setPlutusScripts = self => plutus_scripts => errorableToPurs(self.set_plutus_scripts.bind(self), plutus_scripts);
export const auxiliaryData_preferAlonzoFormat = self => self.prefer_alonzo_format.bind(self)();
export const auxiliaryData_setPreferAlonzoFormat = self => prefer => errorableToPurs(self.set_prefer_alonzo_format.bind(self), prefer);
...
// FixedTransaction
export const fixedTransaction_new = raw_body => raw_witness_set => is_valid => CSL.FixedTransaction.new(raw_body, raw_witness_set, is_valid);
export const fixedTransaction_newWithAuxiliary = raw_body => raw_witness_set => raw_auxiliary_data => is_valid => CSL.FixedTransaction.new_with_auxiliary(raw_body, raw_witness_set, raw_auxiliary_data, is_valid);
...
export const fixedTransaction_setBody = self => raw_body => errorableToPurs(self.set_body.bind(self), raw_body);
export const fixedTransaction_setWitnessSet = self => raw_witness_set => errorableToPurs(self.set_witness_set.bind(self), raw_witness_set);
export const fixedTransaction_witnessSet = self => self.witness_set.bind(self)();
export const fixedTransaction_rawWitnessSet = self => self.raw_witness_set.bind(self)();
export const fixedTransaction_setIsValid = self => valid => errorableToPurs(self.set_is_valid.bind(self), valid);
export const fixedTransaction_isValid = self => self.is_valid.bind(self)();
export const fixedTransaction_setAuxiliaryData = self => raw_auxiliary_data => errorableToPurs(self.set_auxiliary_data.bind(self), raw_auxiliary_data);
export const fixedTransaction_auxiliaryData = self => self.auxiliary_data.bind(self)();
...
// ProtocolParamUpdate
export const protocolParamUpdate_setMinfeeA = self => minfee_a => errorableToPurs(self.set_minfee_a.bind(self), minfee_a);
export const protocolParamUpdate_minfeeA = self => self.minfee_a.bind(self)();
export const protocolParamUpdate_setMinfeeB = self => minfee_b => errorableToPurs(self.set_minfee_b.bind(self), minfee_b);
export const protocolParamUpdate_minfeeB = self => self.minfee_b.bind(self)();
export const protocolParamUpdate_setMaxBlockBodySize = self => max_block_body_size => errorableToPurs(self.set_max_block_body_size.bind(self), max_block_body_size);
export const protocolParamUpdate_maxBlockBodySize = self => self.max_block_body_size.bind(self)();
export const protocolParamUpdate_setMaxTxSize = self => max_tx_size => errorableToPurs(self.set_max_tx_size.bind(self), max_tx_size);
export const protocolParamUpdate_maxTxSize = self => self.max_tx_size.bind(self)();
export const protocolParamUpdate_setMaxBlockHeaderSize = self => max_block_header_size => errorableToPurs(self.set_max_block_header_size.bind(self), max_block_header_size);
export const protocolParamUpdate_maxBlockHeaderSize = self => self.max_block_header_size.bind(self)();
export const protocolParamUpdate_setKeyDeposit = self => key_deposit => errorableToPurs(self.set_key_deposit.bind(self), key_deposit);
export const protocolParamUpdate_keyDeposit = self => self.key_deposit.bind(self)();
export const protocolParamUpdate_setPoolDeposit = self => pool_deposit => errorableToPurs(self.set_pool_deposit.bind(self), pool_deposit);
export const protocolParamUpdate_poolDeposit = self => self.pool_deposit.bind(self)();
export const protocolParamUpdate_setMaxEpoch = self => max_epoch => errorableToPurs(self.set_max_epoch.bind(self), max_epoch);
export const protocolParamUpdate_maxEpoch = self => self.max_epoch.bind(self)();
export const protocolParamUpdate_setNOpt = self => n_opt => errorableToPurs(self.set_n_opt.bind(self), n_opt);
export const protocolParamUpdate_nOpt = self => self.n_opt.bind(self)();
export const protocolParamUpdate_setPoolPledgeInfluence = self => pool_pledge_influence => errorableToPurs(self.set_pool_pledge_influence.bind(self), pool_pledge_influence);
export const protocolParamUpdate_poolPledgeInfluence = self => self.pool_pledge_influence.bind(self)();
export const protocolParamUpdate_setExpansionRate = self => expansion_rate => errorableToPurs(self.set_expansion_rate.bind(self), expansion_rate);
export const protocolParamUpdate_expansionRate = self => self.expansion_rate.bind(self)();
export const protocolParamUpdate_setTreasuryGrowthRate = self => treasury_growth_rate => errorableToPurs(self.set_treasury_growth_rate.bind(self), treasury_growth_rate);
...
export const protocolParamUpdate_setProtocolVersion = self => protocol_version => errorableToPurs(self.set_protocol_version.bind(self), protocol_version);
export const protocolParamUpdate_protocolVersion = self => self.protocol_version.bind(self)();
export const protocolParamUpdate_setMinPoolCost = self => min_pool_cost => errorableToPurs(self.set_min_pool_cost.bind(self), min_pool_cost);
export const protocolParamUpdate_minPoolCost = self => self.min_pool_cost.bind(self)();
export const protocolParamUpdate_setAdaPerUtxoByte = self => ada_per_utxo_byte => errorableToPurs(self.set_ada_per_utxo_byte.bind(self), ada_per_utxo_byte);
export const protocolParamUpdate_adaPerUtxoByte = self => self.ada_per_utxo_byte.bind(self)();
export const protocolParamUpdate_setCostModels = self => cost_models => errorableToPurs(self.set_cost_models.bind(self), cost_models);
export const protocolParamUpdate_costModels = self => self.cost_models.bind(self)();
export const protocolParamUpdate_setExecutionCosts = self => execution_costs => errorableToPurs(self.set_execution_costs.bind(self), execution_costs);
export const protocolParamUpdate_executionCosts = self => self.execution_costs.bind(self)();
export const protocolParamUpdate_setMaxTxExUnits = self => max_tx_ex_units => errorableToPurs(self.set_max_tx_ex_units.bind(self), max_tx_ex_units);
export const protocolParamUpdate_maxTxExUnits = self => self.max_tx_ex_units.bind(self)();
export const protocolParamUpdate_setMaxBlockExUnits = self => max_block_ex_units => errorableToPurs(self.set_max_block_ex_units.bind(self), max_block_ex_units);
export const protocolParamUpdate_maxBlockExUnits = self => self.max_block_ex_units.bind(self)();
export const protocolParamUpdate_setMaxValueSize = self => max_value_size => errorableToPurs(self.set_max_value_size.bind(self), max_value_size);
export const protocolParamUpdate_maxValueSize = self => self.max_value_size.bind(self)();
export const protocolParamUpdate_setCollateralPercentage = self => collateral_percentage => errorableToPurs(self.set_collateral_percentage.bind(self), collateral_percentage);
export const protocolParamUpdate_collateralPercentage = self => self.collateral_percentage.bind(self)();
export const protocolParamUpdate_setMaxCollateralInputs = self => max_collateral_inputs => errorableToPurs(self.set_max_collateral_inputs.bind(self), max_collateral_inputs);
...
export const transaction_setIsValid = self => valid => errorableToPurs(self.set_is_valid.bind(self), valid);
...
export const transactionBody_setTtl = self => ttl => errorableToPurs(self.set_ttl.bind(self), ttl);
export const transactionBody_removeTtl = self => errorableToPurs(self.remove_ttl.bind(self), );
export const transactionBody_setCerts = self => certs => errorableToPurs(self.set_certs.bind(self), certs);
export const transactionBody_certs = self => self.certs.bind(self)();
export const transactionBody_setWithdrawals = self => withdrawals => errorableToPurs(self.set_withdrawals.bind(self), withdrawals);
export const transactionBody_withdrawals = self => self.withdrawals.bind(self)();
export const transactionBody_setUpdate = self => update => errorableToPurs(self.set_update.bind(self), update);
export const transactionBody_update = self => self.update.bind(self)();
export const transactionBody_setAuxiliaryDataHash = self => auxiliary_data_hash => errorableToPurs(self.set_auxiliary_data_hash.bind(self), auxiliary_data_hash);
export const transactionBody_auxiliaryDataHash = self => self.auxiliary_data_hash.bind(self)();
export const transactionBody_setValidityStartInterval = self => validity_start_interval => errorableToPurs(self.set_validity_start_interval.bind(self), validity_start_interval);
export const transactionBody_setValidityStartIntervalBignum = self => validity_start_interval => errorableToPurs(self.set_validity_start_interval_bignum.bind(self), validity_start_interval);
...
export const transactionBody_setMint = self => mint => errorableToPurs(self.set_mint.bind(self), mint);
...
export const transactionBody_setReferenceInputs = self => reference_inputs => errorableToPurs(self.set_reference_inputs.bind(self), reference_inputs);
export const transactionBody_referenceInputs = self => self.reference_inputs.bind(self)();
export const transactionBody_setScriptDataHash = self => script_data_hash => errorableToPurs(self.set_script_data_hash.bind(self), script_data_hash);
export const transactionBody_scriptDataHash = self => self.script_data_hash.bind(self)();
export const transactionBody_setCollateral = self => collateral => errorableToPurs(self.set_collateral.bind(self), collateral);
export const transactionBody_collateral = self => self.collateral.bind(self)();
export const transactionBody_setRequiredSigners = self => required_signers => errorableToPurs(self.set_required_signers.bind(self), required_signers);
export const transactionBody_requiredSigners = self => self.required_signers.bind(self)();
export const transactionBody_setNetworkId = self => network_id => errorableToPurs(self.set_network_id.bind(self), network_id);
export const transactionBody_networkId = self => self.network_id.bind(self)();
export const transactionBody_setCollateralReturn = self => collateral_return => errorableToPurs(self.set_collateral_return.bind(self), collateral_return);
export const transactionBody_collateralReturn = self => self.collateral_return.bind(self)();
export const transactionBody_setTotalCollateral = self => total_collateral => errorableToPurs(self.set_total_collateral.bind(self), total_collateral);
...
export const value_setCoin = self => coin => errorableToPurs(self.set_coin.bind(self), coin);
