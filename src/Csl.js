...
export const address_fromBytes = data => errorableToPurs(CSL.Address.from_bytes, data);
export const address_toJson = self => self.to_json();
export const address_toJsValue = self => self.to_js_value();
export const address_fromJson = json => errorableToPurs(CSL.Address.from_json, json);
export const address_toHex = self => self.to_hex();
export const address_fromHex = hex_str => errorableToPurs(CSL.Address.from_hex, hex_str);
...
export const assetName_fromBytes = bytes => errorableToPurs(CSL.AssetName.from_bytes, bytes);
export const assetName_toHex = self => self.to_hex();
export const assetName_fromHex = hex_str => errorableToPurs(CSL.AssetName.from_hex, hex_str);
export const assetName_toJson = self => self.to_json();
export const assetName_toJsValue = self => self.to_js_value();
export const assetName_fromJson = json => errorableToPurs(CSL.AssetName.from_json, json);
...
export const assetNames_fromBytes = bytes => errorableToPurs(CSL.AssetNames.from_bytes, bytes);
export const assetNames_toHex = self => self.to_hex();
export const assetNames_fromHex = hex_str => errorableToPurs(CSL.AssetNames.from_hex, hex_str);
export const assetNames_toJson = self => self.to_json();
export const assetNames_toJsValue = self => self.to_js_value();
export const assetNames_fromJson = json => errorableToPurs(CSL.AssetNames.from_json, json);
...
export const assets_fromBytes = bytes => errorableToPurs(CSL.Assets.from_bytes, bytes);
export const assets_toHex = self => self.to_hex();
export const assets_fromHex = hex_str => errorableToPurs(CSL.Assets.from_hex, hex_str);
export const assets_toJson = self => self.to_json();
export const assets_toJsValue = self => self.to_js_value();
export const assets_fromJson = json => errorableToPurs(CSL.Assets.from_json, json);
...
export const auxiliaryData_fromBytes = bytes => errorableToPurs(CSL.AuxiliaryData.from_bytes, bytes);
export const auxiliaryData_toHex = self => self.to_hex();
export const auxiliaryData_fromHex = hex_str => errorableToPurs(CSL.AuxiliaryData.from_hex, hex_str);
export const auxiliaryData_toJson = self => self.to_json();
export const auxiliaryData_toJsValue = self => self.to_js_value();
export const auxiliaryData_fromJson = json => errorableToPurs(CSL.AuxiliaryData.from_json, json);
...
export const auxiliaryDataHash_fromBytes = bytes => errorableToPurs(CSL.AuxiliaryDataHash.from_bytes, bytes);
...
export const auxiliaryDataHash_fromHex = hex => errorableToPurs(CSL.AuxiliaryDataHash.from_hex, hex);
...
export const bigInt_fromBytes = bytes => errorableToPurs(CSL.BigInt.from_bytes, bytes);
export const bigInt_toHex = self => self.to_hex();
export const bigInt_fromHex = hex_str => errorableToPurs(CSL.BigInt.from_hex, hex_str);
export const bigInt_toJson = self => self.to_json();
export const bigInt_toJsValue = self => self.to_js_value();
export const bigInt_fromJson = json => errorableToPurs(CSL.BigInt.from_json, json);
...
export const bigNum_fromBytes = bytes => errorableToPurs(CSL.BigNum.from_bytes, bytes);
export const bigNum_toHex = self => self.to_hex();
export const bigNum_fromHex = hex_str => errorableToPurs(CSL.BigNum.from_hex, hex_str);
export const bigNum_toJson = self => self.to_json();
export const bigNum_toJsValue = self => self.to_js_value();
export const bigNum_fromJson = json => errorableToPurs(CSL.BigNum.from_json, json);
...
export const bip32PrivateKey_fromBytes = bytes => errorableToPurs(CSL.Bip32PrivateKey.from_bytes, bytes);
...
export const bip32PrivateKey_fromHex = hex_str => errorableToPurs(CSL.Bip32PrivateKey.from_hex, hex_str);
...
export const bip32PublicKey_fromBytes = bytes => errorableToPurs(CSL.Bip32PublicKey.from_bytes, bytes);
...
export const bip32PublicKey_fromHex = hex_str => errorableToPurs(CSL.Bip32PublicKey.from_hex, hex_str);

// Block
export const block_free = self => () => self.free();
export const block_toBytes = self => self.to_bytes();
export const block_fromBytes = bytes => errorableToPurs(CSL.Block.from_bytes, bytes);
export const block_toHex = self => self.to_hex();
export const block_fromHex = hex_str => errorableToPurs(CSL.Block.from_hex, hex_str);
export const block_toJson = self => self.to_json();
export const block_toJsValue = self => self.to_js_value();
export const block_fromJson = json => errorableToPurs(CSL.Block.from_json, json);
...
export const blockHash_fromBytes = bytes => errorableToPurs(CSL.BlockHash.from_bytes, bytes);
...
export const blockHash_fromHex = hex => errorableToPurs(CSL.BlockHash.from_hex, hex);

// BootstrapWitness
export const bootstrapWitness_free = self => () => self.free();
export const bootstrapWitness_toBytes = self => self.to_bytes();
export const bootstrapWitness_fromBytes = bytes => errorableToPurs(CSL.BootstrapWitness.from_bytes, bytes);
export const bootstrapWitness_toHex = self => self.to_hex();
export const bootstrapWitness_fromHex = hex_str => errorableToPurs(CSL.BootstrapWitness.from_hex, hex_str);
export const bootstrapWitness_toJson = self => self.to_json();
export const bootstrapWitness_toJsValue = self => self.to_js_value();
export const bootstrapWitness_fromJson = json => errorableToPurs(CSL.BootstrapWitness.from_json, json);
...
export const byronAddress_fromBytes = bytes => errorableToPurs(CSL.ByronAddress.from_bytes, bytes);
...
export const certificate_fromBytes = bytes => errorableToPurs(CSL.Certificate.from_bytes, bytes);
export const certificate_toHex = self => self.to_hex();
export const certificate_fromHex = hex_str => errorableToPurs(CSL.Certificate.from_hex, hex_str);
export const certificate_toJson = self => self.to_json();
export const certificate_toJsValue = self => self.to_js_value();
export const certificate_fromJson = json => errorableToPurs(CSL.Certificate.from_json, json);
...
export const certificates_fromBytes = bytes => errorableToPurs(CSL.Certificates.from_bytes, bytes);
export const certificates_toHex = self => self.to_hex();
export const certificates_fromHex = hex_str => errorableToPurs(CSL.Certificates.from_hex, hex_str);
export const certificates_toJson = self => self.to_json();
export const certificates_toJsValue = self => self.to_js_value();
export const certificates_fromJson = json => errorableToPurs(CSL.Certificates.from_json, json);
...
export const constrPlutusData_fromBytes = bytes => errorableToPurs(CSL.ConstrPlutusData.from_bytes, bytes);
export const constrPlutusData_toHex = self => self.to_hex();
export const constrPlutusData_fromHex = hex_str => errorableToPurs(CSL.ConstrPlutusData.from_hex, hex_str);
export const constrPlutusData_toJson = self => self.to_json();
export const constrPlutusData_toJsValue = self => self.to_js_value();
export const constrPlutusData_fromJson = json => errorableToPurs(CSL.ConstrPlutusData.from_json, json);
...
export const costmdls_fromBytes = bytes => errorableToPurs(CSL.Costmdls.from_bytes, bytes);
export const costmdls_toHex = self => self.to_hex();
export const costmdls_fromHex = hex_str => errorableToPurs(CSL.Costmdls.from_hex, hex_str);
export const costmdls_toJson = self => self.to_json();
export const costmdls_toJsValue = self => self.to_js_value();
export const costmdls_fromJson = json => errorableToPurs(CSL.Costmdls.from_json, json);
...
export const dnsRecordAorAAAA_fromBytes = bytes => errorableToPurs(CSL.DNSRecordAorAAAA.from_bytes, bytes);
export const dnsRecordAorAAAA_toHex = self => self.to_hex();
export const dnsRecordAorAAAA_fromHex = hex_str => errorableToPurs(CSL.DNSRecordAorAAAA.from_hex, hex_str);
export const dnsRecordAorAAAA_toJson = self => self.to_json();
export const dnsRecordAorAAAA_toJsValue = self => self.to_js_value();
export const dnsRecordAorAAAA_fromJson = json => errorableToPurs(CSL.DNSRecordAorAAAA.from_json, json);
...
export const dnsRecordSRV_fromBytes = bytes => errorableToPurs(CSL.DNSRecordSRV.from_bytes, bytes);
export const dnsRecordSRV_toHex = self => self.to_hex();
export const dnsRecordSRV_fromHex = hex_str => errorableToPurs(CSL.DNSRecordSRV.from_hex, hex_str);
export const dnsRecordSRV_toJson = self => self.to_json();
export const dnsRecordSRV_toJsValue = self => self.to_js_value();
export const dnsRecordSRV_fromJson = json => errorableToPurs(CSL.DNSRecordSRV.from_json, json);
...
export const dataHash_fromBytes = bytes => errorableToPurs(CSL.DataHash.from_bytes, bytes);
...
export const dataHash_fromHex = hex => errorableToPurs(CSL.DataHash.from_hex, hex);
...
export const ed25519KeyHash_fromBytes = bytes => errorableToPurs(CSL.Ed25519KeyHash.from_bytes, bytes);
...
export const ed25519KeyHash_fromHex = hex => errorableToPurs(CSL.Ed25519KeyHash.from_hex, hex);

// Ed25519KeyHashes
export const ed25519KeyHashes_free = self => () => self.free();
export const ed25519KeyHashes_toBytes = self => self.to_bytes();
export const ed25519KeyHashes_fromBytes = bytes => errorableToPurs(CSL.Ed25519KeyHashes.from_bytes, bytes);
export const ed25519KeyHashes_toHex = self => self.to_hex();
export const ed25519KeyHashes_fromHex = hex_str => errorableToPurs(CSL.Ed25519KeyHashes.from_hex, hex_str);
export const ed25519KeyHashes_toJson = self => self.to_json();
export const ed25519KeyHashes_toJsValue = self => self.to_js_value();
export const ed25519KeyHashes_fromJson = json => errorableToPurs(CSL.Ed25519KeyHashes.from_json, json);
...
export const ed25519Signature_fromHex = input => errorableToPurs(CSL.Ed25519Signature.from_hex, input);
export const ed25519Signature_fromBytes = bytes => errorableToPurs(CSL.Ed25519Signature.from_bytes, bytes);
...
export const exUnitPrices_fromBytes = bytes => errorableToPurs(CSL.ExUnitPrices.from_bytes, bytes);
export const exUnitPrices_toHex = self => self.to_hex();
export const exUnitPrices_fromHex = hex_str => errorableToPurs(CSL.ExUnitPrices.from_hex, hex_str);
export const exUnitPrices_toJson = self => self.to_json();
export const exUnitPrices_toJsValue = self => self.to_js_value();
export const exUnitPrices_fromJson = json => errorableToPurs(CSL.ExUnitPrices.from_json, json);
...
export const exUnits_fromBytes = bytes => errorableToPurs(CSL.ExUnits.from_bytes, bytes);
export const exUnits_toHex = self => self.to_hex();
export const exUnits_fromHex = hex_str => errorableToPurs(CSL.ExUnits.from_hex, hex_str);
export const exUnits_toJson = self => self.to_json();
export const exUnits_toJsValue = self => self.to_js_value();
export const exUnits_fromJson = json => errorableToPurs(CSL.ExUnits.from_json, json);
...
export const generalTxMetadata_fromBytes = bytes => errorableToPurs(CSL.GeneralTransactionMetadata.from_bytes, bytes);
export const generalTxMetadata_toHex = self => self.to_hex();
export const generalTxMetadata_fromHex = hex_str => errorableToPurs(CSL.GeneralTransactionMetadata.from_hex, hex_str);
export const generalTxMetadata_toJson = self => self.to_json();
export const generalTxMetadata_toJsValue = self => self.to_js_value();
export const generalTxMetadata_fromJson = json => errorableToPurs(CSL.GeneralTransactionMetadata.from_json, json);
...
export const genesisDelegateHash_fromBytes = bytes => errorableToPurs(CSL.GenesisDelegateHash.from_bytes, bytes);
...
export const genesisDelegateHash_fromHex = hex => errorableToPurs(CSL.GenesisDelegateHash.from_hex, hex);

// GenesisHash
export const genesisHash_free = self => () => self.free();
export const genesisHash_fromBytes = bytes => errorableToPurs(CSL.GenesisHash.from_bytes, bytes);
...
export const genesisHash_fromHex = hex => errorableToPurs(CSL.GenesisHash.from_hex, hex);

// GenesisHashes
export const genesisHashes_free = self => () => self.free();
export const genesisHashes_toBytes = self => self.to_bytes();
export const genesisHashes_fromBytes = bytes => errorableToPurs(CSL.GenesisHashes.from_bytes, bytes);
export const genesisHashes_toHex = self => self.to_hex();
export const genesisHashes_fromHex = hex_str => errorableToPurs(CSL.GenesisHashes.from_hex, hex_str);
export const genesisHashes_toJson = self => self.to_json();
export const genesisHashes_toJsValue = self => self.to_js_value();
export const genesisHashes_fromJson = json => errorableToPurs(CSL.GenesisHashes.from_json, json);
...
export const genesisKeyDelegation_fromBytes = bytes => errorableToPurs(CSL.GenesisKeyDelegation.from_bytes, bytes);
export const genesisKeyDelegation_toHex = self => self.to_hex();
export const genesisKeyDelegation_fromHex = hex_str => errorableToPurs(CSL.GenesisKeyDelegation.from_hex, hex_str);
...
export const genesisKeyDelegation_fromJson = json => errorableToPurs(CSL.GenesisKeyDelegation.from_json, json);
...
export const header_fromBytes = bytes => errorableToPurs(CSL.Header.from_bytes, bytes);
export const header_toHex = self => self.to_hex();
export const header_fromHex = hex_str => errorableToPurs(CSL.Header.from_hex, hex_str);
export const header_toJson = self => self.to_json();
export const header_toJsValue = self => self.to_js_value();
export const header_fromJson = json => errorableToPurs(CSL.Header.from_json, json);
...
export const headerBody_fromBytes = bytes => errorableToPurs(CSL.HeaderBody.from_bytes, bytes);
export const headerBody_toHex = self => self.to_hex();
export const headerBody_fromHex = hex_str => errorableToPurs(CSL.HeaderBody.from_hex, hex_str);
export const headerBody_toJson = self => self.to_json();
export const headerBody_toJsValue = self => self.to_js_value();
export const headerBody_fromJson = json => errorableToPurs(CSL.HeaderBody.from_json, json);
...
export const int_fromBytes = bytes => errorableToPurs(CSL.Int.from_bytes, bytes);
export const int_toHex = self => self.to_hex();
export const int_fromHex = hex_str => errorableToPurs(CSL.Int.from_hex, hex_str);
export const int_toJson = self => self.to_json();
export const int_toJsValue = self => self.to_js_value();
export const int_fromJson = json => errorableToPurs(CSL.Int.from_json, json);
...
export const ipv4_fromBytes = bytes => errorableToPurs(CSL.Ipv4.from_bytes, bytes);
export const ipv4_toHex = self => self.to_hex();
export const ipv4_fromHex = hex_str => errorableToPurs(CSL.Ipv4.from_hex, hex_str);
export const ipv4_toJson = self => self.to_json();
export const ipv4_toJsValue = self => self.to_js_value();
export const ipv4_fromJson = json => errorableToPurs(CSL.Ipv4.from_json, json);
...
export const ipv6_fromBytes = bytes => errorableToPurs(CSL.Ipv6.from_bytes, bytes);
export const ipv6_toHex = self => self.to_hex();
export const ipv6_fromHex = hex_str => errorableToPurs(CSL.Ipv6.from_hex, hex_str);
export const ipv6_toJson = self => self.to_json();
export const ipv6_toJsValue = self => self.to_js_value();
export const ipv6_fromJson = json => errorableToPurs(CSL.Ipv6.from_json, json);
...
export const kesSignature_fromBytes = bytes => errorableToPurs(CSL.KESSignature.from_bytes, bytes);

// KESVKey
export const kesvKey_free = self => () => self.free();
export const kesvKey_fromBytes = bytes => errorableToPurs(CSL.KESVKey.from_bytes, bytes);
...
export const kesvKey_fromHex = hex => errorableToPurs(CSL.KESVKey.from_hex, hex);

// Language
export const language_free = self => () => self.free();
export const language_toBytes = self => self.to_bytes();
export const language_fromBytes = bytes => errorableToPurs(CSL.Language.from_bytes, bytes);
export const language_toHex = self => self.to_hex();
export const language_fromHex = hex_str => errorableToPurs(CSL.Language.from_hex, hex_str);
export const language_toJson = self => self.to_json();
export const language_toJsValue = self => self.to_js_value();
export const language_fromJson = json => errorableToPurs(CSL.Language.from_json, json);
...
export const legacyDaedalusPrivateKey_fromBytes = bytes => errorableToPurs(CSL.LegacyDaedalusPrivateKey.from_bytes, bytes);
...
export const mirToStakeCredentials_fromBytes = bytes => errorableToPurs(CSL.MIRToStakeCredentials.from_bytes, bytes);
export const mirToStakeCredentials_toHex = self => self.to_hex();
export const mirToStakeCredentials_fromHex = hex_str => errorableToPurs(CSL.MIRToStakeCredentials.from_hex, hex_str);
...
export const mirToStakeCredentials_fromJson = json => errorableToPurs(CSL.MIRToStakeCredentials.from_json, json);
...
export const metadataList_fromBytes = bytes => errorableToPurs(CSL.MetadataList.from_bytes, bytes);
export const metadataList_toHex = self => self.to_hex();
export const metadataList_fromHex = hex_str => errorableToPurs(CSL.MetadataList.from_hex, hex_str);
...
export const metadataMap_fromBytes = bytes => errorableToPurs(CSL.MetadataMap.from_bytes, bytes);
export const metadataMap_toHex = self => self.to_hex();
export const metadataMap_fromHex = hex_str => errorableToPurs(CSL.MetadataMap.from_hex, hex_str);
...
export const mint_fromBytes = bytes => errorableToPurs(CSL.Mint.from_bytes, bytes);
export const mint_toHex = self => self.to_hex();
export const mint_fromHex = hex_str => errorableToPurs(CSL.Mint.from_hex, hex_str);
export const mint_toJson = self => self.to_json();
export const mint_toJsValue = self => self.to_js_value();
export const mint_fromJson = json => errorableToPurs(CSL.Mint.from_json, json);
...
export const moveInstantaneousReward_fromBytes = bytes => errorableToPurs(CSL.MoveInstantaneousReward.from_bytes, bytes);
export const moveInstantaneousReward_toHex = self => self.to_hex();
export const moveInstantaneousReward_fromHex = hex_str => errorableToPurs(CSL.MoveInstantaneousReward.from_hex, hex_str);
...
export const moveInstantaneousReward_fromJson = json => errorableToPurs(CSL.MoveInstantaneousReward.from_json, json);
...
export const moveInstantaneousRewardsCert_fromBytes = bytes => errorableToPurs(CSL.MoveInstantaneousRewardsCert.from_bytes, bytes);
export const moveInstantaneousRewardsCert_toHex = self => self.to_hex();
export const moveInstantaneousRewardsCert_fromHex = hex_str => errorableToPurs(CSL.MoveInstantaneousRewardsCert.from_hex, hex_str);
...
export const moveInstantaneousRewardsCert_fromJson = json => errorableToPurs(CSL.MoveInstantaneousRewardsCert.from_json, json);
...
export const multiAsset_fromBytes = bytes => errorableToPurs(CSL.MultiAsset.from_bytes, bytes);
export const multiAsset_toHex = self => self.to_hex();
export const multiAsset_fromHex = hex_str => errorableToPurs(CSL.MultiAsset.from_hex, hex_str);
export const multiAsset_toJson = self => self.to_json();
export const multiAsset_toJsValue = self => self.to_js_value();
export const multiAsset_fromJson = json => errorableToPurs(CSL.MultiAsset.from_json, json);
...
export const multiHostName_fromBytes = bytes => errorableToPurs(CSL.MultiHostName.from_bytes, bytes);
export const multiHostName_toHex = self => self.to_hex();
export const multiHostName_fromHex = hex_str => errorableToPurs(CSL.MultiHostName.from_hex, hex_str);
export const multiHostName_toJson = self => self.to_json();
export const multiHostName_toJsValue = self => self.to_js_value();
export const multiHostName_fromJson = json => errorableToPurs(CSL.MultiHostName.from_json, json);
...
export const nativeScript_fromBytes = bytes => errorableToPurs(CSL.NativeScript.from_bytes, bytes);
export const nativeScript_toHex = self => self.to_hex();
export const nativeScript_fromHex = hex_str => errorableToPurs(CSL.NativeScript.from_hex, hex_str);
export const nativeScript_toJson = self => self.to_json();
export const nativeScript_toJsValue = self => self.to_js_value();
export const nativeScript_fromJson = json => errorableToPurs(CSL.NativeScript.from_json, json);
...
export const networkId_fromBytes = bytes => errorableToPurs(CSL.NetworkId.from_bytes, bytes);
export const networkId_toHex = self => self.to_hex();
export const networkId_fromHex = hex_str => errorableToPurs(CSL.NetworkId.from_hex, hex_str);
export const networkId_toJson = self => self.to_json();
export const networkId_toJsValue = self => self.to_js_value();
export const networkId_fromJson = json => errorableToPurs(CSL.NetworkId.from_json, json);
...
export const nonce_fromBytes = bytes => errorableToPurs(CSL.Nonce.from_bytes, bytes);
export const nonce_toHex = self => self.to_hex();
export const nonce_fromHex = hex_str => errorableToPurs(CSL.Nonce.from_hex, hex_str);
export const nonce_toJson = self => self.to_json();
export const nonce_toJsValue = self => self.to_js_value();
export const nonce_fromJson = json => errorableToPurs(CSL.Nonce.from_json, json);
...
export const operationalCert_fromBytes = bytes => errorableToPurs(CSL.OperationalCert.from_bytes, bytes);
export const operationalCert_toHex = self => self.to_hex();
export const operationalCert_fromHex = hex_str => errorableToPurs(CSL.OperationalCert.from_hex, hex_str);
export const operationalCert_toJson = self => self.to_json();
export const operationalCert_toJsValue = self => self.to_js_value();
export const operationalCert_fromJson = json => errorableToPurs(CSL.OperationalCert.from_json, json);
...
export const plutusData_fromBytes = bytes => errorableToPurs(CSL.PlutusData.from_bytes, bytes);
export const plutusData_toHex = self => self.to_hex();
export const plutusData_fromHex = hex_str => errorableToPurs(CSL.PlutusData.from_hex, hex_str);
export const plutusData_toJson = self => self.to_json();
export const plutusData_toJsValue = self => self.to_js_value();
export const plutusData_fromJson = json => errorableToPurs(CSL.PlutusData.from_json, json);
...
export const plutusList_fromBytes = bytes => errorableToPurs(CSL.PlutusList.from_bytes, bytes);
export const plutusList_toHex = self => self.to_hex();
export const plutusList_fromHex = hex_str => errorableToPurs(CSL.PlutusList.from_hex, hex_str);
export const plutusList_toJson = self => self.to_json();
export const plutusList_toJsValue = self => self.to_js_value();
export const plutusList_fromJson = json => errorableToPurs(CSL.PlutusList.from_json, json);
...
export const plutusMap_fromBytes = bytes => errorableToPurs(CSL.PlutusMap.from_bytes, bytes);
export const plutusMap_toHex = self => self.to_hex();
export const plutusMap_fromHex = hex_str => errorableToPurs(CSL.PlutusMap.from_hex, hex_str);
export const plutusMap_toJson = self => self.to_json();
export const plutusMap_toJsValue = self => self.to_js_value();
export const plutusMap_fromJson = json => errorableToPurs(CSL.PlutusMap.from_json, json);
...
export const plutusScript_fromBytes = bytes => errorableToPurs(CSL.PlutusScript.from_bytes, bytes);
export const plutusScript_toHex = self => self.to_hex();
export const plutusScript_fromHex = hex_str => errorableToPurs(CSL.PlutusScript.from_hex, hex_str);
...
export const plutusScripts_fromBytes = bytes => errorableToPurs(CSL.PlutusScripts.from_bytes, bytes);
export const plutusScripts_toHex = self => self.to_hex();
export const plutusScripts_fromHex = hex_str => errorableToPurs(CSL.PlutusScripts.from_hex, hex_str);
export const plutusScripts_toJson = self => self.to_json();
export const plutusScripts_toJsValue = self => self.to_js_value();
export const plutusScripts_fromJson = json => errorableToPurs(CSL.PlutusScripts.from_json, json);
...
export const poolMetadata_fromBytes = bytes => errorableToPurs(CSL.PoolMetadata.from_bytes, bytes);
export const poolMetadata_toHex = self => self.to_hex();
export const poolMetadata_fromHex = hex_str => errorableToPurs(CSL.PoolMetadata.from_hex, hex_str);
export const poolMetadata_toJson = self => self.to_json();
export const poolMetadata_toJsValue = self => self.to_js_value();
export const poolMetadata_fromJson = json => errorableToPurs(CSL.PoolMetadata.from_json, json);
...
export const poolMetadataHash_fromBytes = bytes => errorableToPurs(CSL.PoolMetadataHash.from_bytes, bytes);
...
export const poolMetadataHash_fromHex = hex => errorableToPurs(CSL.PoolMetadataHash.from_hex, hex);

// PoolParams
export const poolParams_free = self => () => self.free();
export const poolParams_toBytes = self => self.to_bytes();
export const poolParams_fromBytes = bytes => errorableToPurs(CSL.PoolParams.from_bytes, bytes);
export const poolParams_toHex = self => self.to_hex();
export const poolParams_fromHex = hex_str => errorableToPurs(CSL.PoolParams.from_hex, hex_str);
export const poolParams_toJson = self => self.to_json();
export const poolParams_toJsValue = self => self.to_js_value();
export const poolParams_fromJson = json => errorableToPurs(CSL.PoolParams.from_json, json);
...
export const poolRegistration_fromBytes = bytes => errorableToPurs(CSL.PoolRegistration.from_bytes, bytes);
export const poolRegistration_toHex = self => self.to_hex();
export const poolRegistration_fromHex = hex_str => errorableToPurs(CSL.PoolRegistration.from_hex, hex_str);
export const poolRegistration_toJson = self => self.to_json();
export const poolRegistration_toJsValue = self => self.to_js_value();
export const poolRegistration_fromJson = json => errorableToPurs(CSL.PoolRegistration.from_json, json);
...
export const poolRetirement_fromBytes = bytes => errorableToPurs(CSL.PoolRetirement.from_bytes, bytes);
export const poolRetirement_toHex = self => self.to_hex();
export const poolRetirement_fromHex = hex_str => errorableToPurs(CSL.PoolRetirement.from_hex, hex_str);
export const poolRetirement_toJson = self => self.to_json();
export const poolRetirement_toJsValue = self => self.to_js_value();
export const poolRetirement_fromJson = json => errorableToPurs(CSL.PoolRetirement.from_json, json);
...
export const proposedProtocolParameterUpdates_fromBytes = bytes => errorableToPurs(CSL.ProposedProtocolParameterUpdates.from_bytes, bytes);
export const proposedProtocolParameterUpdates_toHex = self => self.to_hex();
export const proposedProtocolParameterUpdates_fromHex = hex_str => errorableToPurs(CSL.ProposedProtocolParameterUpdates.from_hex, hex_str);
...
export const proposedProtocolParameterUpdates_fromJson = json => errorableToPurs(CSL.ProposedProtocolParameterUpdates.from_json, json);
...
export const protocolParamUpdate_fromBytes = bytes => errorableToPurs(CSL.ProtocolParamUpdate.from_bytes, bytes);
export const protocolParamUpdate_toHex = self => self.to_hex();
export const protocolParamUpdate_fromHex = hex_str => errorableToPurs(CSL.ProtocolParamUpdate.from_hex, hex_str);
...
export const protocolParamUpdate_fromJson = json => errorableToPurs(CSL.ProtocolParamUpdate.from_json, json);
...
export const protocolVersion_fromBytes = bytes => errorableToPurs(CSL.ProtocolVersion.from_bytes, bytes);
export const protocolVersion_toHex = self => self.to_hex();
export const protocolVersion_fromHex = hex_str => errorableToPurs(CSL.ProtocolVersion.from_hex, hex_str);
export const protocolVersion_toJson = self => self.to_json();
export const protocolVersion_toJsValue = self => self.to_js_value();
export const protocolVersion_fromJson = json => errorableToPurs(CSL.ProtocolVersion.from_json, json);
...
export const redeemer_fromBytes = bytes => errorableToPurs(CSL.Redeemer.from_bytes, bytes);
export const redeemer_toHex = self => self.to_hex();
export const redeemer_fromHex = hex_str => errorableToPurs(CSL.Redeemer.from_hex, hex_str);
export const redeemer_toJson = self => self.to_json();
export const redeemer_toJsValue = self => self.to_js_value();
export const redeemer_fromJson = json => errorableToPurs(CSL.Redeemer.from_json, json);
...
export const redeemerTag_fromBytes = bytes => errorableToPurs(CSL.RedeemerTag.from_bytes, bytes);
export const redeemerTag_toHex = self => self.to_hex();
export const redeemerTag_fromHex = hex_str => errorableToPurs(CSL.RedeemerTag.from_hex, hex_str);
export const redeemerTag_toJson = self => self.to_json();
export const redeemerTag_toJsValue = self => self.to_js_value();
export const redeemerTag_fromJson = json => errorableToPurs(CSL.RedeemerTag.from_json, json);
...
export const redeemers_fromBytes = bytes => errorableToPurs(CSL.Redeemers.from_bytes, bytes);
export const redeemers_toHex = self => self.to_hex();
export const redeemers_fromHex = hex_str => errorableToPurs(CSL.Redeemers.from_hex, hex_str);
export const redeemers_toJson = self => self.to_json();
export const redeemers_toJsValue = self => self.to_js_value();
export const redeemers_fromJson = json => errorableToPurs(CSL.Redeemers.from_json, json);
...
export const relay_fromBytes = bytes => errorableToPurs(CSL.Relay.from_bytes, bytes);
export const relay_toHex = self => self.to_hex();
export const relay_fromHex = hex_str => errorableToPurs(CSL.Relay.from_hex, hex_str);
export const relay_toJson = self => self.to_json();
export const relay_toJsValue = self => self.to_js_value();
export const relay_fromJson = json => errorableToPurs(CSL.Relay.from_json, json);
...
export const relays_fromBytes = bytes => errorableToPurs(CSL.Relays.from_bytes, bytes);
export const relays_toHex = self => self.to_hex();
export const relays_fromHex = hex_str => errorableToPurs(CSL.Relays.from_hex, hex_str);
export const relays_toJson = self => self.to_json();
export const relays_toJsValue = self => self.to_js_value();
export const relays_fromJson = json => errorableToPurs(CSL.Relays.from_json, json);
...
export const rewardAddresses_fromBytes = bytes => errorableToPurs(CSL.RewardAddresses.from_bytes, bytes);
export const rewardAddresses_toHex = self => self.to_hex();
export const rewardAddresses_fromHex = hex_str => errorableToPurs(CSL.RewardAddresses.from_hex, hex_str);
export const rewardAddresses_toJson = self => self.to_json();
export const rewardAddresses_toJsValue = self => self.to_js_value();
export const rewardAddresses_fromJson = json => errorableToPurs(CSL.RewardAddresses.from_json, json);
...
export const scriptAll_fromBytes = bytes => errorableToPurs(CSL.ScriptAll.from_bytes, bytes);
export const scriptAll_toHex = self => self.to_hex();
export const scriptAll_fromHex = hex_str => errorableToPurs(CSL.ScriptAll.from_hex, hex_str);
export const scriptAll_toJson = self => self.to_json();
export const scriptAll_toJsValue = self => self.to_js_value();
export const scriptAll_fromJson = json => errorableToPurs(CSL.ScriptAll.from_json, json);
...
export const scriptAny_fromBytes = bytes => errorableToPurs(CSL.ScriptAny.from_bytes, bytes);
export const scriptAny_toHex = self => self.to_hex();
export const scriptAny_fromHex = hex_str => errorableToPurs(CSL.ScriptAny.from_hex, hex_str);
export const scriptAny_toJson = self => self.to_json();
export const scriptAny_toJsValue = self => self.to_js_value();
export const scriptAny_fromJson = json => errorableToPurs(CSL.ScriptAny.from_json, json);
...
export const scriptDataHash_fromBytes = bytes => errorableToPurs(CSL.ScriptDataHash.from_bytes, bytes);
...
export const scriptDataHash_fromHex = hex => errorableToPurs(CSL.ScriptDataHash.from_hex, hex);

// ScriptHash
export const scriptHash_free = self => () => self.free();
export const scriptHash_fromBytes = bytes => errorableToPurs(CSL.ScriptHash.from_bytes, bytes);
...
export const scriptHash_fromHex = hex => errorableToPurs(CSL.ScriptHash.from_hex, hex);

// ScriptHashes
export const scriptHashes_free = self => () => self.free();
export const scriptHashes_toBytes = self => self.to_bytes();
export const scriptHashes_fromBytes = bytes => errorableToPurs(CSL.ScriptHashes.from_bytes, bytes);
export const scriptHashes_toHex = self => self.to_hex();
export const scriptHashes_fromHex = hex_str => errorableToPurs(CSL.ScriptHashes.from_hex, hex_str);
export const scriptHashes_toJson = self => self.to_json();
export const scriptHashes_toJsValue = self => self.to_js_value();
export const scriptHashes_fromJson = json => errorableToPurs(CSL.ScriptHashes.from_json, json);
...
export const scriptNOfK_fromBytes = bytes => errorableToPurs(CSL.ScriptNOfK.from_bytes, bytes);
export const scriptNOfK_toHex = self => self.to_hex();
export const scriptNOfK_fromHex = hex_str => errorableToPurs(CSL.ScriptNOfK.from_hex, hex_str);
export const scriptNOfK_toJson = self => self.to_json();
export const scriptNOfK_toJsValue = self => self.to_js_value();
export const scriptNOfK_fromJson = json => errorableToPurs(CSL.ScriptNOfK.from_json, json);
...
export const scriptPubkey_fromBytes = bytes => errorableToPurs(CSL.ScriptPubkey.from_bytes, bytes);
export const scriptPubkey_toHex = self => self.to_hex();
export const scriptPubkey_fromHex = hex_str => errorableToPurs(CSL.ScriptPubkey.from_hex, hex_str);
export const scriptPubkey_toJson = self => self.to_json();
export const scriptPubkey_toJsValue = self => self.to_js_value();
export const scriptPubkey_fromJson = json => errorableToPurs(CSL.ScriptPubkey.from_json, json);
...
export const scriptRef_fromBytes = bytes => errorableToPurs(CSL.ScriptRef.from_bytes, bytes);
export const scriptRef_toHex = self => self.to_hex();
export const scriptRef_fromHex = hex_str => errorableToPurs(CSL.ScriptRef.from_hex, hex_str);
export const scriptRef_toJson = self => self.to_json();
export const scriptRef_toJsValue = self => self.to_js_value();
export const scriptRef_fromJson = json => errorableToPurs(CSL.ScriptRef.from_json, json);
...
export const singleHostAddr_fromBytes = bytes => errorableToPurs(CSL.SingleHostAddr.from_bytes, bytes);
export const singleHostAddr_toHex = self => self.to_hex();
export const singleHostAddr_fromHex = hex_str => errorableToPurs(CSL.SingleHostAddr.from_hex, hex_str);
export const singleHostAddr_toJson = self => self.to_json();
export const singleHostAddr_toJsValue = self => self.to_js_value();
export const singleHostAddr_fromJson = json => errorableToPurs(CSL.SingleHostAddr.from_json, json);
...
export const singleHostName_fromBytes = bytes => errorableToPurs(CSL.SingleHostName.from_bytes, bytes);
export const singleHostName_toHex = self => self.to_hex();
export const singleHostName_fromHex = hex_str => errorableToPurs(CSL.SingleHostName.from_hex, hex_str);
export const singleHostName_toJson = self => self.to_json();
export const singleHostName_toJsValue = self => self.to_js_value();
export const singleHostName_fromJson = json => errorableToPurs(CSL.SingleHostName.from_json, json);
...
export const stakeCredential_fromBytes = bytes => errorableToPurs(CSL.StakeCredential.from_bytes, bytes);
export const stakeCredential_toHex = self => self.to_hex();
export const stakeCredential_fromHex = hex_str => errorableToPurs(CSL.StakeCredential.from_hex, hex_str);
export const stakeCredential_toJson = self => self.to_json();
export const stakeCredential_toJsValue = self => self.to_js_value();
export const stakeCredential_fromJson = json => errorableToPurs(CSL.StakeCredential.from_json, json);

// StakeCredentials
export const stakeCredentials_free = self => () => self.free();
export const stakeCredentials_toBytes = self => self.to_bytes();
export const stakeCredentials_fromBytes = bytes => errorableToPurs(CSL.StakeCredentials.from_bytes, bytes);
export const stakeCredentials_toHex = self => self.to_hex();
export const stakeCredentials_fromHex = hex_str => errorableToPurs(CSL.StakeCredentials.from_hex, hex_str);
export const stakeCredentials_toJson = self => self.to_json();
export const stakeCredentials_toJsValue = self => self.to_js_value();
export const stakeCredentials_fromJson = json => errorableToPurs(CSL.StakeCredentials.from_json, json);
...
export const stakeDelegation_fromBytes = bytes => errorableToPurs(CSL.StakeDelegation.from_bytes, bytes);
export const stakeDelegation_toHex = self => self.to_hex();
export const stakeDelegation_fromHex = hex_str => errorableToPurs(CSL.StakeDelegation.from_hex, hex_str);
export const stakeDelegation_toJson = self => self.to_json();
export const stakeDelegation_toJsValue = self => self.to_js_value();
export const stakeDelegation_fromJson = json => errorableToPurs(CSL.StakeDelegation.from_json, json);
...
export const stakeDeregistration_fromBytes = bytes => errorableToPurs(CSL.StakeDeregistration.from_bytes, bytes);
export const stakeDeregistration_toHex = self => self.to_hex();
export const stakeDeregistration_fromHex = hex_str => errorableToPurs(CSL.StakeDeregistration.from_hex, hex_str);
...
export const stakeDeregistration_fromJson = json => errorableToPurs(CSL.StakeDeregistration.from_json, json);
...
export const stakeRegistration_fromBytes = bytes => errorableToPurs(CSL.StakeRegistration.from_bytes, bytes);
export const stakeRegistration_toHex = self => self.to_hex();
export const stakeRegistration_fromHex = hex_str => errorableToPurs(CSL.StakeRegistration.from_hex, hex_str);
export const stakeRegistration_toJson = self => self.to_json();
export const stakeRegistration_toJsValue = self => self.to_js_value();
export const stakeRegistration_fromJson = json => errorableToPurs(CSL.StakeRegistration.from_json, json);
...
export const timelockExpiry_fromBytes = bytes => errorableToPurs(CSL.TimelockExpiry.from_bytes, bytes);
export const timelockExpiry_toHex = self => self.to_hex();
export const timelockExpiry_fromHex = hex_str => errorableToPurs(CSL.TimelockExpiry.from_hex, hex_str);
export const timelockExpiry_toJson = self => self.to_json();
export const timelockExpiry_toJsValue = self => self.to_js_value();
export const timelockExpiry_fromJson = json => errorableToPurs(CSL.TimelockExpiry.from_json, json);
...
export const timelockStart_fromBytes = bytes => errorableToPurs(CSL.TimelockStart.from_bytes, bytes);
export const timelockStart_toHex = self => self.to_hex();
export const timelockStart_fromHex = hex_str => errorableToPurs(CSL.TimelockStart.from_hex, hex_str);
export const timelockStart_toJson = self => self.to_json();
export const timelockStart_toJsValue = self => self.to_js_value();
export const timelockStart_fromJson = json => errorableToPurs(CSL.TimelockStart.from_json, json);
...
export const tx_fromBytes = bytes => errorableToPurs(CSL.Transaction.from_bytes, bytes);
export const tx_toHex = self => self.to_hex();
export const tx_fromHex = hex_str => errorableToPurs(CSL.Transaction.from_hex, hex_str);
export const tx_toJson = self => self.to_json();
export const tx_toJsValue = self => self.to_js_value();
export const tx_fromJson = json => errorableToPurs(CSL.Transaction.from_json, json);
...
export const txBodies_fromBytes = bytes => errorableToPurs(CSL.TransactionBodies.from_bytes, bytes);
export const txBodies_toHex = self => self.to_hex();
export const txBodies_fromHex = hex_str => errorableToPurs(CSL.TransactionBodies.from_hex, hex_str);
export const txBodies_toJson = self => self.to_json();
export const txBodies_toJsValue = self => self.to_js_value();
export const txBodies_fromJson = json => errorableToPurs(CSL.TransactionBodies.from_json, json);
...
export const txBody_fromBytes = bytes => errorableToPurs(CSL.TransactionBody.from_bytes, bytes);
export const txBody_toHex = self => self.to_hex();
export const txBody_fromHex = hex_str => errorableToPurs(CSL.TransactionBody.from_hex, hex_str);
export const txBody_toJson = self => self.to_json();
export const txBody_toJsValue = self => self.to_js_value();
export const txBody_fromJson = json => errorableToPurs(CSL.TransactionBody.from_json, json);
...
export const txHash_fromBytes = bytes => errorableToPurs(CSL.TransactionHash.from_bytes, bytes);
export const txHash_toBytes = self => self.to_bytes();
export const txHash_toBech32 = self => prefix => self.to_bech32(prefix);
export const txHash_fromBech32 = bech_str => errorableToPurs(CSL.TransactionHash.from_bech32, bech_str);
export const txHash_toHex = self => self.to_hex();
export const txHash_fromHex = hex => errorableToPurs(CSL.TransactionHash.from_hex, hex);

// TransactionInput
export const txIn_free = self => () => self.free();
export const txIn_toBytes = self => self.to_bytes();
export const txIn_fromBytes = bytes => errorableToPurs(CSL.TransactionInput.from_bytes, bytes);
export const txIn_toHex = self => self.to_hex();
export const txIn_fromHex = hex_str => errorableToPurs(CSL.TransactionInput.from_hex, hex_str);
export const txIn_toJson = self => self.to_json();
export const txIn_toJsValue = self => self.to_js_value();
export const txIn_fromJson = json => errorableToPurs(CSL.TransactionInput.from_json, json);
...
export const txIns_fromBytes = bytes => errorableToPurs(CSL.TransactionInputs.from_bytes, bytes);
export const txIns_toHex = self => self.to_hex();
export const txIns_fromHex = hex_str => errorableToPurs(CSL.TransactionInputs.from_hex, hex_str);
export const txIns_toJson = self => self.to_json();
export const txIns_toJsValue = self => self.to_js_value();
export const txIns_fromJson = json => errorableToPurs(CSL.TransactionInputs.from_json, json);
...
export const txMetadatum_fromBytes = bytes => errorableToPurs(CSL.TransactionMetadatum.from_bytes, bytes);
export const txMetadatum_toHex = self => self.to_hex();
export const txMetadatum_fromHex = hex_str => errorableToPurs(CSL.TransactionMetadatum.from_hex, hex_str);
...
export const txMetadatumLabels_fromBytes = bytes => errorableToPurs(CSL.TransactionMetadatumLabels.from_bytes, bytes);
export const txMetadatumLabels_toHex = self => self.to_hex();
export const txMetadatumLabels_fromHex = hex_str => errorableToPurs(CSL.TransactionMetadatumLabels.from_hex, hex_str);
...
export const txOut_fromBytes = bytes => errorableToPurs(CSL.TransactionOutput.from_bytes, bytes);
export const txOut_toHex = self => self.to_hex();
export const txOut_fromHex = hex_str => errorableToPurs(CSL.TransactionOutput.from_hex, hex_str);
export const txOut_toJson = self => self.to_json();
export const txOut_toJsValue = self => self.to_js_value();
export const txOut_fromJson = json => errorableToPurs(CSL.TransactionOutput.from_json, json);
...
export const txOuts_fromBytes = bytes => errorableToPurs(CSL.TransactionOutputs.from_bytes, bytes);
export const txOuts_toHex = self => self.to_hex();
export const txOuts_fromHex = hex_str => errorableToPurs(CSL.TransactionOutputs.from_hex, hex_str);
export const txOuts_toJson = self => self.to_json();
export const txOuts_toJsValue = self => self.to_js_value();
export const txOuts_fromJson = json => errorableToPurs(CSL.TransactionOutputs.from_json, json);
...
export const txUnspentOut_fromBytes = bytes => errorableToPurs(CSL.TransactionUnspentOutput.from_bytes, bytes);
export const txUnspentOut_toHex = self => self.to_hex();
export const txUnspentOut_fromHex = hex_str => errorableToPurs(CSL.TransactionUnspentOutput.from_hex, hex_str);
export const txUnspentOut_toJson = self => self.to_json();
export const txUnspentOut_toJsValue = self => self.to_js_value();
export const txUnspentOut_fromJson = json => errorableToPurs(CSL.TransactionUnspentOutput.from_json, json);
...
export const txUnspentOuts_fromJson = json => errorableToPurs(CSL.TransactionUnspentOutputs.from_json, json);
...
export const txWitnessSet_fromBytes = bytes => errorableToPurs(CSL.TransactionWitnessSet.from_bytes, bytes);
export const txWitnessSet_toHex = self => self.to_hex();
export const txWitnessSet_fromHex = hex_str => errorableToPurs(CSL.TransactionWitnessSet.from_hex, hex_str);
export const txWitnessSet_toJson = self => self.to_json();
export const txWitnessSet_toJsValue = self => self.to_js_value();
export const txWitnessSet_fromJson = json => errorableToPurs(CSL.TransactionWitnessSet.from_json, json);
...
export const txWitnessSets_fromBytes = bytes => errorableToPurs(CSL.TransactionWitnessSets.from_bytes, bytes);
export const txWitnessSets_toHex = self => self.to_hex();
export const txWitnessSets_fromHex = hex_str => errorableToPurs(CSL.TransactionWitnessSets.from_hex, hex_str);
export const txWitnessSets_toJson = self => self.to_json();
export const txWitnessSets_toJsValue = self => self.to_js_value();
export const txWitnessSets_fromJson = json => errorableToPurs(CSL.TransactionWitnessSets.from_json, json);
...
export const url_fromBytes = bytes => errorableToPurs(CSL.URL.from_bytes, bytes);
export const url_toHex = self => self.to_hex();
export const url_fromHex = hex_str => errorableToPurs(CSL.URL.from_hex, hex_str);
export const url_toJson = self => self.to_json();
export const url_toJsValue = self => self.to_js_value();
export const url_fromJson = json => errorableToPurs(CSL.URL.from_json, json);
...
export const unitInterval_fromBytes = bytes => errorableToPurs(CSL.UnitInterval.from_bytes, bytes);
export const unitInterval_toHex = self => self.to_hex();
export const unitInterval_fromHex = hex_str => errorableToPurs(CSL.UnitInterval.from_hex, hex_str);
export const unitInterval_toJson = self => self.to_json();
export const unitInterval_toJsValue = self => self.to_js_value();
export const unitInterval_fromJson = json => errorableToPurs(CSL.UnitInterval.from_json, json);
...
export const update_fromBytes = bytes => errorableToPurs(CSL.Update.from_bytes, bytes);
export const update_toHex = self => self.to_hex();
export const update_fromHex = hex_str => errorableToPurs(CSL.Update.from_hex, hex_str);
export const update_toJson = self => self.to_json();
export const update_toJsValue = self => self.to_js_value();
export const update_fromJson = json => errorableToPurs(CSL.Update.from_json, json);
...
export const vrfCert_fromBytes = bytes => errorableToPurs(CSL.VRFCert.from_bytes, bytes);
export const vrfCert_toHex = self => self.to_hex();
export const vrfCert_fromHex = hex_str => errorableToPurs(CSL.VRFCert.from_hex, hex_str);
export const vrfCert_toJson = self => self.to_json();
export const vrfCert_toJsValue = self => self.to_js_value();
export const vrfCert_fromJson = json => errorableToPurs(CSL.VRFCert.from_json, json);
...
export const vrfKeyHash_fromBytes = bytes => errorableToPurs(CSL.VRFKeyHash.from_bytes, bytes);
...
export const vrfKeyHash_fromHex = hex => errorableToPurs(CSL.VRFKeyHash.from_hex, hex);

// VRFVKey
export const vrfvKey_free = self => () => self.free();
export const vrfvKey_fromBytes = bytes => errorableToPurs(CSL.VRFVKey.from_bytes, bytes);
...
export const vrfvKey_fromHex = hex => errorableToPurs(CSL.VRFVKey.from_hex, hex);

// Value
export const value_free = self => () => self.free();
export const value_toBytes = self => self.to_bytes();
export const value_fromBytes = bytes => errorableToPurs(CSL.Value.from_bytes, bytes);
export const value_toHex = self => self.to_hex();
export const value_fromHex = hex_str => errorableToPurs(CSL.Value.from_hex, hex_str);
export const value_toJson = self => self.to_json();
export const value_toJsValue = self => self.to_js_value();
export const value_fromJson = json => errorableToPurs(CSL.Value.from_json, json);
...
export const vkey_fromBytes = bytes => errorableToPurs(CSL.Vkey.from_bytes, bytes);
export const vkey_toHex = self => self.to_hex();
export const vkey_fromHex = hex_str => errorableToPurs(CSL.Vkey.from_hex, hex_str);
export const vkey_toJson = self => self.to_json();
export const vkey_toJsValue = self => self.to_js_value();
export const vkey_fromJson = json => errorableToPurs(CSL.Vkey.from_json, json);
...
export const vkeywitness_fromBytes = bytes => errorableToPurs(CSL.Vkeywitness.from_bytes, bytes);
export const vkeywitness_toHex = self => self.to_hex();
export const vkeywitness_fromHex = hex_str => errorableToPurs(CSL.Vkeywitness.from_hex, hex_str);
export const vkeywitness_toJson = self => self.to_json();
export const vkeywitness_toJsValue = self => self.to_js_value();
export const vkeywitness_fromJson = json => errorableToPurs(CSL.Vkeywitness.from_json, json);
...
export const withdrawals_fromBytes = bytes => errorableToPurs(CSL.Withdrawals.from_bytes, bytes);
export const withdrawals_toHex = self => self.to_hex();
export const withdrawals_fromHex = hex_str => errorableToPurs(CSL.Withdrawals.from_hex, hex_str);
export const withdrawals_toJson = self => self.to_json();
export const withdrawals_toJsValue = self => self.to_js_value();
export const withdrawals_fromJson = json => errorableToPurs(CSL.Withdrawals.from_json, json);
